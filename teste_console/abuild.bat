...
echo "Compilando em modo debug..."
    cl /MDd /Zi /nologo /EHsc /std:c++latest /I ..\ /I ..\dependencies /I D:\github\vcpkg\installed\x64-windows\include /c /MP *.cpp
    link /nologo /INCREMENTAL:NO /DEBUG /out:"main.exe" /libpath:"..\dependencies\libs\debug" /LIBPATH:"D:\github\vcpkg\installed\x64-windows\debug\lib" /MACHINE:X64 /MANIFEST:NO *.obj gpp_d.lib gpp_physics_d.lib GameNetworkingSockets.lib libcurl-d.lib
) else (
