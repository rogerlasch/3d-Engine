...
void GetVertices(std::vector<vector3d>& vertices);
  virtual void translate(const vector3d& translation, bool correction=false);//Translada a geometria...
  virtual void scale(const vector3d& origin, float s);//Escala a geometria...
virtual void scale(const vector3d& origin, const vector3d& sc);//Escala a geometria...
