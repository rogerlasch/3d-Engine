...
if "%MODE%"=="debug" (
    ...
    link /nologo /INCREMENTAL:NO /DEBUG /out:"..\main.exe" /libpath:"..\..\dependencies\libs\debug" /LIBPATH:"D:\github\vcpkg\installed\x64-windows\debug\lib" /MACHINE:X64 /MANIFEST:NO *.obj gpp_d.lib GameNetworkingSockets.lib enet.lib libcurl-d.lib
) else (
    ...
    link /nologo /INCREMENTAL:NO /out:"..\main.exe" /libpath:"..\..\dependencies\libs" /LIBPATH:"D:\github\vcpkg\installed\x64-windows\lib" /MACHINE:X64 /MANIFEST:NO *.obj gpp.lib GameNetworkingSockets.lib enet.lib libcurl.lib libcrypto.lib winmm.lib Ws2_32.lib
)
cd ..
del *.exp
del *.lib
